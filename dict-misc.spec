...
Ten pakiet zawiera różne słowniki do używania z serwerem słownika
dictd.
...
Słownik The Devil's Dictionary, zawierający cyniczne i lekceważące
opisy słów - do używania z serwerem słownika dictd.
...
Ten pakiet zawiera słownik Easton's 1897 Bible Dictionary do używania
z serwerem słownika dictd.
...
Ten pakiet zawiera bazę danych informacji o pierwiastkach,
przygotowaną przez Jaya Kominka, do używania z serwerem słownika
dictd.
...
Ten pakiet zawiera słownik The Free On-line Dictionary of Computing do
używania z serwerem słownika dictd.
...
Ten pakiet zawiera słownik Hitchcock's Bible Names Dictionary do
używania z serwerem słownika dictd.
...
Ten pakiet zawiera słownik Free Journalism Dictionary do używania z
serwerem słownika dictd.
...
Ten pakiet zawiera słownik Projektu Tłumaczenia Manuali, do użycia z
serwerem dictd.
...
Ten pakiet zawiera słownik The 2002 CIA World Factbook do używania z
serwerem słownika dictd.
